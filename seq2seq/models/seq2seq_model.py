...
class Seq2SeqModel(ModelBase):
  ...
  def default_params():
    ...
    params.update({
        ...
        "vocab_source": "",
        "vocab_target": "",
        "vocab_source_embedding": "",
        "vocab_target_embedding": "",
    })
    return params
  ...
  def source_embedding(self):
    ...
    """
    if "vocab_source_embedding" in self.params.keys() and self.params["vocab_source_embedding"]:
        return vocab.get_vocab_embedding(
                self.params["vocab_source_embedding"],
  ...
  def target_embedding(self):
    ...
    elif "vocab_target_embedding" in self.params.keys() and self.params["vocab_target_embedding"]:
        return vocab.get_vocab_embedding(
                self.params["vocab_target_embedding"],
